...
2. [HiBitUninstaller](https://hibit-uninstaller.en.softonic.com/)  删除软件
3. [Kazumi看番](https://github.com/Predidit/Kazumi)
4. [NeatDM_setup](https://neatdownloadmanager.com/index.php/en/)  N下载
5. [Notepad3](https://github.com/rizonesoft/Notepad3)  文本编辑器
6. [Office_Tool](https://otp.landian.vip/zh-cn/)  office部署
7. [PixPin](https://pixpin.cn/)  截图
8. [Potplayer](https://potplayer.tv/)  音视频播放器
...
# 大学
# 工具
1. [BOOTICEx64_](https://bootice.en.lo4d.com/windows)  引导工具
2. [ Cinebench Installer](https://cinebench.net/)  测CPU的单核与多核性能
2. [LocalSend](https://localsend.org/zh-CN)  传输文件
3. [MSIAfterburnerInstaller466](https://www.msi.com/Landing/afterburner/graphics-cards)  微星帧率检测小飞机
4. [Obsidian](https://obsidian.md/)   黑曜石 MakeDown编辑器
5. [PrivaZer_free](https://privazer.com/en/download.php)   清理工具
6. [qbittorrent_enhanced_](https://github.com/c0re100/qBittorrent-Enhanced-Edition/releases)  qb种子下载器
7. SoftCnKiller2.82  卡巴斯基

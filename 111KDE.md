...
音频条
pacman -S cava
pacman -S papers    pdf阅读器
pacman -S foliate   电子书阅读器
yay -S watt-toolkit-bin    steam++
```
...
2. 右键>菜单>设置>配置konsole
   ...
   配置方案里新建一个配置方案；外观里点击“获取新方案：下载一个自己喜欢的，我使用catppuccin  frappe。选中喜欢的配色方案后点击编辑设置11%透明度；设置字体为Adwaita  Mono（一个你喜欢的mono等宽字体），大小15pt；”其他“页面里设置边距，取消激活调整大小后显示终端大小提示。光标|字形
